...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('account')->name('account.')->group(function () {
        ...
        // Thêm route mark-paid cho Customer
        Route::patch('/orders/{orderNumber}/mark-paid', [OrderController::class, 'markAsPaid'])->name('orders.markPaid');
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Thêm route mark-paid cho Admin
    Route::patch('orders/{id}/mark-paid', [AdminOrderController::class, 'markAsPaid'])->name('orders.markPaid');
...
// Auth scaffolding routes (Breeze, Jetstream, or Fortify)
