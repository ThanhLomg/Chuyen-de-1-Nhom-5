            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="short_description" id="short_description" rows="2"
                              class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500">{{ old('short_description') }}</textarea>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="price" id="price" value="{{ old('price') }}" step="1000" min="1000"
                    ...
                    <div>
                        ...
                        <input type="number" name="sale_price" id="sale_price" value="{{ old('sale_price') }}" step="1000" min="1000"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="file" name="image" accept="image/*" @change="previewMainImage"
                           class="w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('image') border-red-500 @enderror">
                    @error('image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                    <div class="mt-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1" x-show="galleryPreviews.length > 0">
                        Đã chọn <span x-text="galleryPreviews.length"></span>/6 ảnh
                    </p>
                </div>
            </div>
        </div>
    ...
    function productForm() {
        return {
            ...
            addGalleryImages(event) {
                ...
                const remaining = 6 - this.galleryPreviews.length;
                ...
                if (files.length > remaining) {
                    alert(`Chỉ có thể thêm tối đa 6 ảnh. Đã bỏ qua ${files.length - remaining} ảnh.`);
                }
            },
